 ...
 * 												   		TweenNano.to(mc, 1, {_x:100, _y:200});<br />
 * 														TweenNano.to(mc, 1, {_x:300, delay:2, overwrite:true}); //immediately overwrites the previous tween</code></li>
 * 										</ul></li>
 * 	</ul>
 * 
 * <b>EXAMPLES:</b> <br /><br />
...
class com.greensock.TweenNano {
		private static var version:Number = 1.02;
		/** @private **/
		...
		public function TweenNano(target:Object, duration:Number, vars:Object) {
			...
			if (a == undefined || Number(this.vars.overwrite)) { 
...
//---- STATIC FUNCTIONS -------------------------------------------------------------------------
		 ...
		 * @return TweenNano instance
		 */
		public static function delayedCall(delay:Number, onComplete:Function, onCompleteParams:Array, useFrames:Boolean):TweenNano {
