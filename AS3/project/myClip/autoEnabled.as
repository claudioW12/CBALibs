package project.myClip{
	...
	public class autoEnabled extends MovieClip{
		...
		public function set enab(a:Boolean):void{ dLoader.attr(this, {enabled:a, alpha:a ? aMax : aMin}); }
		
		public function get tog():Boolean{ return this.toggled; }
		
		public function set tog(a:Boolean):void{ dLoader.attr(this, {toggled:a}); }
		
		public function get disab():Boolean{ return this.disabled; }
		
		public function set disab(a:Boolean):void{ dLoader.attr(this, {disabled:a, alpha:!a ? aMax : aMin}); }
